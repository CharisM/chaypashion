...
import { FiPackage, FiFacebook, FiChevronDown, FiChevronUp, FiShoppingBag, FiCheckCircle, FiClock, FiX, FiTruck, FiMapPin, FiPhone, FiMail } from "react-icons/fi";
          ...
          <div className="col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <svg viewBox="0 0 160 160" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 text-white">
                ...
                <rect x="32" y="32" width="96" height="96" rx="2" transform="rotate(45 80 80)" strokeWidth="1.2" fill="none" opacity="0.4" stroke="currentColor"/>
